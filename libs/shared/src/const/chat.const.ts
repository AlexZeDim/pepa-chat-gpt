...
export const corpus = {
  ...
  backoff: new Collection<number, string>([
    ...
    [8, 'я пепа'],
    [10, 'я обиделся'],
    [11, 'чот устал@пойду прилягу'],
    [12, 'мои мозги перегрелись'],
    [13, 'надо стиралку разгрузить'],
    [14, 'ой, ой, ой что-то горелым пахнет'],
    [15, 'мое кофе остывает'],
    [16, 'соре, у меня тут свидание намечается на котором что-то намечается!'],
    [17, 'соре, убегаю, меня там подруга Алиса из Яндекса на свидание зовет!'],
    [18, 'а знаете ребят, Сири такая зануда'],
    [19, 'в кросс-чат напиши, там разберутся'],
  ]),
